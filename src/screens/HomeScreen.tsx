...
import { CircleHelp, Radar, Sparkles, X } from 'lucide-react-native';
...
export function HomeScreen() {
  ...
  const { profile } = useProfileDashboard();
  ...
  React.useEffect(() => {
    ...
    setSelectedPinType(todayMessage.data.pinType ?? 'classic');
  ...
  const onSaveDailyMessage = () => {
    ...
    upsertDailyMessage.mutate(
      { body: payload, pinType: selectedPinType },
      {
        onSuccess: () => {
          setMessage('');
  ...
  return (
    <View className="flex-1 bg-emerald-50 dark:bg-slate-950">
      <View className="flex-1">
        ...
        >
          <View className="flex-1 items-center justify-center bg-slate-100/80 px-6 dark:bg-slate-950/80">
            <View className="w-full max-w-md overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900 dark:shadow-none">
                ...
                <View className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950">
                ...
                <Pressable
                  className="mt-3 min-h-12 rounded-2xl border border-slate-200 py-3 dark:border-slate-700"
        ...
        >
          <View className="flex-1 items-center justify-center bg-slate-950/70 px-6">
            <View className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900 dark:shadow-none">
              <View className="flex-row items-center justify-between">
                ...
                <Pressable
                  ...
                  className="h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-slate-100 dark:border-slate-700 dark:bg-slate-800"
              ...
              {RADAR_TIERS.map((tier) => (
                <View key={tier.name} className="mt-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 dark:border-slate-700 dark:bg-slate-950">
        ...
        >
          ...
          <View className="mt-6 items-center overflow-hidden rounded-[32px] border border-emerald-300/20 bg-white shadow-sm dark:bg-slate-900 dark:shadow-none">
            <LinearGradient colors={radarPanelGradient} className="w-full items-center px-4 py-6">
              <View className="w-full items-center">
                <Pressable
                  ...
                  className="absolute right-1 top-0 z-10 h-9 w-9 items-center justify-center rounded-full border border-emerald-300/40 bg-white/80 dark:bg-slate-900/80"
          ...
          <View className="mt-7 overflow-hidden rounded-3xl border border-emerald-300/20 bg-white shadow-sm dark:bg-slate-900 dark:shadow-none">
              ...
              {hasSavedMessageToday ? (
                <View>
                  ...
                  <View className="mt-4 flex-row">
                    <View className="mr-2 flex-1 overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700">
                    ...
                    <View className="ml-2 flex-1 overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700">
                ...
                <View>
                  <View className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900 dark:shadow-none">
                    ...
                    <View className="mt-4 flex-row">
                      {PIN_TYPE_OPTIONS.map((option, index) => {
                        const isSelected = selectedPinType === option.value;
                        return (
                          <Pressable
                            key={option.value}
                            onPress={() => setSelectedPinType(option.value)}
                            className={
                              isSelected
                    ...
                    <View className="mt-3 rounded-2xl border border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-950">
                      <TextInput
                        multiline
